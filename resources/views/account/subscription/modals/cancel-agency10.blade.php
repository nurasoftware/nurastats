<div class="modal fade" id="cancel_agency10" tabindex="-1" role="dialog" aria-labelledby="ConfirmCancelAg10Label" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content text-start">
            <div class="modal-header">
                <h5 class="modal-title" id="ConfirmCancelAg10Label">{{ __('Cancel subscription') }}</h5>
            ...
            <div class="modal-body">
                ...
                <div class="text-muted fw-bold">
                    <i class="bi bi-info-circle"></i> {{ __('Subscription will end on') }} @if ($next_billing_agency10)<b>{{ date_locale($next_billing_agency10) }}</b>@endif
                    <div class="mb-2"></div>
            ...
            <div class="modal-footer">
                <form method="POST" action="{{ route('central.user.subscription.cancel') }}">
                    {{ csrf_field() }}
                    <input type="hidden" name="subscription" value="agency10">
